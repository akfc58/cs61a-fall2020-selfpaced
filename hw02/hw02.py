...
def next_largest_coin(coin):
    ...
    """
    #print("DEBUG: current coin is:",coin)
    if coin == 1:
        return 5
    elif coin == 5:
        return 10
...
def count_coins(total):
    ...
    def change_helper(total, smallest_coin):
        ...
        if smallest_coin == None:
            return 0
        return change_helper(total - smallest_coin, smallest_coin) + \
        change_helper(total, next_largest_coin(smallest_coin))
